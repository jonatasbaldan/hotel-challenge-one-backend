 ...
 *  class construction.
 */
public class PlaceHolderText extends JLabel
	implements FocusListener, DocumentListener
{
	...
	public PlaceHolderText(String text, JTextComponent component)
	{
		this(text, component, Show.ALWAYS);
	}

	public PlaceHolderText(String text, JTextComponent component, Show show)
	{
